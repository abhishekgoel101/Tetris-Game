...
public class tetris_frame3 extends javax.swing.JFrame {
   ...
   {ex.printStackTrace();}  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tetris_frame3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tetris_frame3().setVisible(true);
            }
        });
    }
      ...
      if(c!='q')
       {
           ...
           */           
           ...
           if(c=='z' && d==null)
           {
            println("Nothing to Undo");    //if nothing to undo still redo stack something is there 
           }
  ...
  public void rowCount(matrix board,Shape s,int M,int N)
  {
   int i,j;
